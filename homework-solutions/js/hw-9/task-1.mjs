...
// 1
let keyWithFourChars = Object.keys(character).filter((element,index) => {
...
let stringValues= Object.values(character).filter((element,index,arr) => {
...
let hasSalaryKey1stOption = Object.hasOwn(character,"salary");
for(const key in character) {
   key !== "salary";
   hasSalaryKey2ndOption = false
